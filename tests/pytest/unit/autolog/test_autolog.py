...
def test_start_loop_single_iteration(
    mock_post_request,
    mock_define_body,
    mock_check_condition,
    mock_define_trigger,
    mock_user_data,
):
...
def test_main(
    mock_start_loop, mock_read_data, mock_argparser, mock_args, mock_user_data
):
...
@patch("autolog.autolog.define_trigger_action")
@patch("autolog.autolog.check_multiple_condition")
def test_start_loop_with_condition(
    mock_check_condition, mock_define_trigger, mock_user_data
):
    """Test start_loop with condition not met"""
    mock_define_trigger.return_value = True
    mock_check_condition.return_value = False
...
@patch("autolog.autolog.define_body")
@patch("autolog.autolog.post_request")
def test_start_loop_without_context(
    mock_post_request,
    mock_define_body,
    mock_check_condition,
    mock_define_trigger,
...
@patch("autolog.autolog.define_body")
@patch("autolog.autolog.post_request")
def test_start_loop_without_condition(
    mock_post_request,
    mock_define_body,
    mock_define_trigger,
    mock_user_data_without_condition,
):
